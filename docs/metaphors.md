...
| City | System-scale orientation: districts, blocks, and skyline | selected type as downtown city hall, members as the plaza, relation groups as districts of buildings, distant context as suburbs; building height and footprint encode metrics |
...
- City emphasizes system scale, neighborhoods, and a metric-driven skyline where every symbol stands on a shared ground plane.
